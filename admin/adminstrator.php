    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">ADMINSTRATOR:</h1>

            <div class="card shadow mb-4">
    <div class="card-header py-3">

<div class="card-body">
      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add_admin_modal">
          ADD
        </button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add adminstrator</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="title">Full Names:</label>
          <input type="text" class="form-control" name="full_names" placeholder="Enter names">
        </div>
        <div class="form-group">
        ...
        <input type="hidden" name="add_admin_details" value="1">
        <input type="button" class="btn btn-info" name="Year" id="add_admin_btn" value="save">
      </form>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form id="edit_room_form"  enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="title">Monthly Fee:</label>
...
<!-- Modal -->
  ...
  <script src="js/adminTEST-3.js"></script>
