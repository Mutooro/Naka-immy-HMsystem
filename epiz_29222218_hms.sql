...
-- Generation Time: May 12, 2022 at 09:53 AM
...
(60, '12', '2026', '35000', 'Verified', 'ad12');
...
(12, 'Magufuli Hostel', 6, 35000, 'Allowed', '1625394549_img-8.jpg', '2'),
...
('sydney', 'kibanga', 'M', '4356', 'wert', '2021', 'Diploma', '6578', 'mfn tg', 'zbhntj', 'ngdnj', '23456', '346578', 'sydneykb38@gmail.com', '1234');
...
--
ALTER TABLE `bookings`
  MODIFY `booking_id` int(150) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `hostel_name`
--
ALTER TABLE `hostel_name`
  MODIFY `hostel_id` int(150) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `receipts_tbl`
  MODIFY `receipt_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
