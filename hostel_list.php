...
<head>
  ...
  <title>Hostels - Hostel Booking</title>
...
<body id="page-top">
      ...
      <div id="content">
       ...
       <?php include("include_user/top_bar.php"); ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h2 mb-4 text-gray-800">ALL HOSTELS:</h1>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Created by Nakaziba &copy; 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="js_2/load_hostel_roomXX.js"></script>
